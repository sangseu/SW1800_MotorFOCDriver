 ...
 *    Date:           10/01/08                                         *
 扇区号与电压参考矢量的关系如下 :
 N=4*Vref3+2*Vref2+Vref1，当电压参考矢量大于0时则1，小于
 0时，为0，则N=1时，Vref3 <0,Vref2<0,Vref1>0,001,此时参考电压
 落在第2扇区，因此有[Vref3 Vref2 Vref1]=[110,101,100,011,010,001]对应
 的扇区分别为[5(240-360),3(120-180),4(180-240),1(0-60),6(300-360),2(60-120)]
 **********************************************************************/
